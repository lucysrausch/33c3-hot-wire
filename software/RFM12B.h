...
class RFM12B
{
  ...
  void SPIInit();
    ...
    void SendStart(uint8_t toNodeId, const void* sendBuf, uint8_t sendLen, bool requestACK=false, bool sendACK=false, uint8_t waitMode=false);
    void SendACK(const void* sendBuf = "", uint8_t sendLen=0, uint8_t waitMode=false);
    void Send(uint8_t toNodeId, const void* sendBuf, uint8_t sendLen, bool requestACK = false, uint8_t waitMode=false);
